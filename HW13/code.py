...
def webpage():
    ...
    <p class="dotted">The time elapsed from stopwatch is
    <span style="color: deeppink;"><span id="clock">{clock}</span> seconds </span></p><br>

   <br>
    <h1> Control the stopwatch with these buttons:</h1>
    <p><button class="button" name="clockON" value="ON" type="submit">START TIME</button></a></p>
    <p><button class="button" name="clockOFF" value="OFF" type="submit">END TIME</button></a></p>
